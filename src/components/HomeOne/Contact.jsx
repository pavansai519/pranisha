                        ...
                        <div className="info-column col-xl-7 col-lg-6 order-2">
                            <div className="inner-column wow fadeInRight">
                                ...
                                <div className="info-box">
                                  ...
                                  <div className="text">Reliable and scalable cloud solutions designed to support your business anytime, anywhere.</div>
                                </div>
                                <div className="info-box">
                                  <span className="icon fa fa-check"></span>
                                  <h5 className="title">End to End Solutions</h5>
                                  <div className="text">Complete digital services from planning to execution—everything you need in one place.</div>
                                </div>
                            </div>
                        </div>
