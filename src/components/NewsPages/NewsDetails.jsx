...
import NewsDtls from '../../assets/images/resource/news-details.jpg';
                    ...
                    <div className="blog-details__left">
                      ...
                      <div className="comment-one">
                        ...
                        <div className="comment-one__single">
                          <div className="comment-one__image"> <img src={TestiImg1} alt=""/> </div>
                        ...
                        <div className="comment-one__single">
                          <div className="comment-one__image"> <img src={TestiImg2} alt=""/> </div>
                          <div className="comment-one__content">
                            <h3>Sarah Albert</h3>
                            <p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla.
                              Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla,
                    ...
                    <div className="sidebar">
                      ...
                      <div className="sidebar__single sidebar__post">
                        ...
                        <ul className="sidebar__post-list list-unstyled">
                          <li>
                            <div className="sidebar__post-image"> <img src={NewsImg1} alt=""/> </div>
                          ...
                          <li>
                            <div className="sidebar__post-image"> <img src={NewsImg2} alt=""/> </div>
                            <div className="sidebar__post-content">
                              <h3> <span className="sidebar__post-content-meta"><i
                          ...
                          <li>
                            <div className="sidebar__post-image"> <img src={NewsImg3} alt=""/> </div>
                            <div className="sidebar__post-content">
                              <h3> <span className="sidebar__post-content-meta"><i
                      ...
                      <div className="sidebar__single sidebar__category">
                        ...
                        <ul className="sidebar__category-list list-unstyled">
                          <li><Link to="/news-details">Artifical Intelligence<span className="icon-right-arrow"></span></Link> </li>
                          <li className="active"><Link to="/news-details">Cloud Solution<span className="icon-right-arrow"></span></Link></li>
                          <li><Link to="/news-details">Cyber Data<span className="icon-right-arrow"></span></Link> </li>
                          <li><Link to="/news-details">SEO Marketing<span className="icon-right-arrow"></span></Link> </li>
                          <li><Link to="/news-details">UI/UX Design<span className="icon-right-arrow"></span></Link> </li>
