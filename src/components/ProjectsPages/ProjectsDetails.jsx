...
import ProjectDtls from '../../assets/images/resource/project-details.jpg';
                    ...
                    <div className="row">
                        <div className="col-xl-12">
                            <div className="project-details__top">
                                <div className="project-details__img"> <img src={ProjectDtls} alt=""/> </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-xl-8 col-lg-8">
                                <div className="project-details__content-left">
                                    ...
                                    <p className="">When an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing. Neque porro est qui dolorem ipsumo.</p>
                                </div>
                            </div>
                                    ...
                                    <div className="project-details__details-box">
                                        ...
                                        <ul className="list-unstyled project-details__details-list">
                                            ...
                                            <li>
                                                ...
                                                <h4 className="project-details__name">company Ltd</h4>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <div className="project-details__social"> <Link to="#"><i className="fab fa-twitter"></i></Link> <Link to="#"><i className="fab fa-facebook"></i></Link> <Link to="#"><i className="fab fa-pinterest-p"></i></Link> <Link to="#"><i className="fab fa-instagram"></i></Link> </div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
