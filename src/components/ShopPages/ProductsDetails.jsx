...
const productrltd = [
  { id: 1, img: RelatedProduct1, title: "Headphone ", price: "$32.00" },
  { id: 2, img: RelatedProduct2, title: "Lagage ", price: "$32.00" },
  { id: 3, img: RelatedProduct3, title: "Watch ", price: "$32.00" },
  { id: 4, img: RelatedProduct4, title: "SD Card ", price: "$32.00" },
];
                            ...
                            <div key={productrltd.id} className="product-block col-lg-3 col-md-6">
                                <div className="inner-box">
                                    <div className="image-box">
                                        <div className="image"><Link to="/products-details"><img src={productrltd.img} alt="Related Product" /></Link></div>
