            ...
            <div className="header-lower">
                <div className="main-box">
                    <div className="logo-box">
                        <div className="logo"><Link to="/"><img src={logo2} alt="Logo" title="Techo"/></Link></div>
                    </div>
                    ...
                    <div className="nav-outer">
                        ...
                        <div className="outer-box">
                            ...
                            <Link to="/contact" className="theme-btn btn-style-one"><span className="btn-title">get solution</span></Link>
